...
const carouselData: CarouselItem[] = [
    {
        ...
        heading: "Meningkatkan kesadaran kesehatan di lingkungan sekolah",
        description:
            "Melalui kegiatan UKS dan PMR, siswa mendapatkan edukasi tentang pola hidup sehat, kebersihan diri, serta pentingnya menjaga kesehatan sejak dini. Pengetahuan ini membantu siswa membangun kebiasaan sehat dalam kehidupan sehari-hari.",
        image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1400&q=90",
    },
    {
        id: "pelatihan-p3k",
        category: "Pelatihan P3K",
        heading: "Belajar pertolongan pertama untuk situasi darurat",
        description:
            "Anggota PMR dilatih untuk memberikan pertolongan pertama pada kecelakaan ringan yang terjadi di sekolah. Keterampilan ini meliputi penanganan luka, pingsan, hingga tindakan dasar sebelum bantuan medis datang.",
        image: "https://images.unsplash.com/photo-1507537297725-24a1c029d3ca?w=1400&q=90",
    },
    {
        id: "kegiatan-sosial",
        category: "Kegiatan Sosial",
        heading: "Membangun kepedulian dan jiwa kemanusiaan siswa",
        description:
            "PMR tidak hanya belajar tentang kesehatan, tetapi juga menanamkan nilai kemanusiaan. Berbagai kegiatan sosial seperti donor darah, kampanye kesehatan, dan aksi kemanusiaan membantu siswa menjadi lebih peduli terhadap sesama.",
        image: "https://images.unsplash.com/photo-1531482615713-2afd69097998?w=1400&q=90",
    },
    {
        id: "lingkungan-sehat",
        category: "Lingkungan Sehat",
        heading: "Menciptakan lingkungan sekolah yang bersih dan sehat",
        description:
            "UKS dan PMR berperan aktif dalam menjaga kebersihan serta kesehatan lingkungan sekolah. Program seperti pemeriksaan kesehatan sederhana, kampanye kebersihan, dan pengelolaan lingkungan membantu menciptakan sekolah yang lebih sehat.",
            ...
            >
                ...
                >
                    <h2 style={{
                        ...
                        Apa yang membuat<br />
                        <em style={{ fontStyle: "italic", fontWeight: 700 }}>kegiatan PMR & UKS</em>{" "}
                        <span style={{ fontWeight: 400 }}>di sekolah kami berbeda</span>
                    </h2>
                </div>
